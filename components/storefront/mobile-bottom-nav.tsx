...
export function MobileBottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 border-t border-[var(--border)] bg-white/95 pb-[env(safe-area-inset-bottom)] shadow-[0_-10px_30px_rgba(57,64,74,0.08)] backdrop-blur md:hidden">
...
function MobileNavLink({ href, label, icon, badge }: { href: string; label: string; icon: React.ReactNode; badge?: number }) {
  return (
    <Link className="relative flex h-15 flex-col items-center justify-center gap-1 text-[11px] font-semibold" href={href}>
